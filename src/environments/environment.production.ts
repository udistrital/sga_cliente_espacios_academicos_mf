...
export const environment = {
  production: true,
  apiUrl: 'https://sgaespaciosacademicos.portaloas.udistrital.edu.co/',
  NUXEO_SERVICE:
  ...
  ESPACIO_ACADEMICO_MID_SERVICE:
    'https://autenticacion.portaloas.udistrital.edu.co/apioas/espacio_academico_mid/v1/',
};
